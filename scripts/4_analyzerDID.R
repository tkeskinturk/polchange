...
# --- EXPORT
png(
  "./figures/did_specificationsA.png",
  w = 12,
  h = 6,
  units = "in",
  res = 500
...
# --- EXPORT
png(
  "./figures/did_specificationsB.png",
  w = 12,
  h = 6,
  units = "in",
  res = 500
